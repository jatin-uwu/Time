sap.ui.define([
    ...
    return Controller.extend("timesheet.app.controller.Notifications", {
        ...
        _loadNotifications() {
            ...
            // (so managers don't see notifications generated by their own
            // approvals on someone else's timesheet).
            const mine = items.filter(n => {
                if (n.recipientEmployeeId) return n.recipientEmployeeId === sCurrentId;
                return sCurrentId !== "EMP1005"; // legacy fallback for plain employee
            });
